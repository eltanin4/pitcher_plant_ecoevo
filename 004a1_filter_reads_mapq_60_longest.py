...
df = pd.read_csv( '~/main/lte/minimap2_axsr_results/D19-2600' + str(mg_num) + '_minimap2_axsr_results.paf', sep='\t', header=None, names=col_names_minimap2 )
...
filt_d.to_csv( 'D19-2600' + str(mg_num) + '_minimap2_axsr_results_filt.paf', sep='\t', index=False, header=False )
