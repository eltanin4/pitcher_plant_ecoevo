...
df = pd.read_csv( 'D19-260' + str(mg_num) + '_minimap2_axsr_results_filt.paf', sep='\t', header=None, names=col_names_minimap2 )
...
filt_d_final.to_csv( 'D19-260' + str(mg_num) + '_minimap2_axsr_results_filt_dup.paf', sep='\t', index=False, header=False )
