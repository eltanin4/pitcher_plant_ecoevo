...
for this_mic in range( 1, 11 ):
    ...
    if len( valid_snps[ this_mic - 1 ][ g_num ] ) > NUM_VALID_SNPS:
        ...
        # Saving results.
        np.savetxt( '/home/akshitg/lte/metagenomes_lte/freebayes_out/snps/all_alleles/fb_spearman_corrs/valid_snps_mic_' 
                    + str( this_mic ) + '_gnm_' + str( g_num ) + '.txt', 
                    valid_snps[ this_mic - 1 ][ g_num ] )
        np.savetxt( '/home/akshitg/lte/metagenomes_lte/freebayes_out/snps/all_alleles/fb_spearman_corrs/corr_matrix_mic_' 
                    + str( this_mic ) + '_gnm_' + str( g_num ) + '.txt', 
                    this_matrix )
        np.savetxt( '/home/akshitg/lte/metagenomes_lte/freebayes_out/snps/all_alleles/fb_spearman_corrs/sign_matrix_mic_' 
                    + str( this_mic ) + '_gnm_' + str( g_num ) + '.txt', 
                    pval_matrix )
