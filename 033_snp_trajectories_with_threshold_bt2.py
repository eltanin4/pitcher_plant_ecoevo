...
for g_num in g_num_list:
    ...
    for this_idx, this_time in enumerate( tm00 ):
        ...
        try:
            df = pd.read_csv( '/home/akshitg/lte/metagenomes_lte/freebayes_out/snps/bt2/all_alleles/fb_processed/mg_'
    ...
    for this_idx, this_time in enumerate( tm00 ):
        try:
            # Going from time point to time point.
            tdf[ this_idx ] = pd.read_csv( '/home/akshitg/lte/metagenomes_lte/freebayes_out/snps/bt2/all_alleles/fb_processed/mg_'
                                           + str( this_time ) + '_gnm_' + str( g_num ) +
                                           '_processed_snps.tsv', sep='\t', index_col=0 )
    ...
    snp_traj_df.to_csv( '/home/akshitg/lte/metagenomes_lte/freebayes_out/snps/bt2/all_alleles/fb_trajs/mic_'
