...
for g_num in g_num_list:
    ...
    for this_idx, this_time in enumerate( tm00 ):
        ...
        try:
            df = pd.read_csv( '/home/akshitg/lte/metagenomes_lte/freebayes_out/snps/with_alleles/fb_processed/mg_'
    ...
    for this_idx, this_time in enumerate( tm00 ):
            ...
            if len( ndf ):
                ...
                ndf.to_csv( '/home/akshitg/lte/metagenomes_lte/freebayes_out/snps/with_alleles/fb_final//mg_'
